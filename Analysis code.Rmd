...
#Fixed effects of final covariates included in MNLFA model
HOMElmer1 = lmer(HOMEETA1 ~ 1 + AGE + AGE_2 + BLACK + (1|SID), data = HOME, REML = FALSE)
summary(HOMElmer1)
#plot(HOMElmer1)
#icc(HOMElmer1)

#Random effects of linear age
HOMElmer2 = lmer(HOMEETA1 ~ 1 + AGE + AGE_2 + BLACK + (1+AGE|SID), data = HOME, REML = FALSE,
               control=lmerControl(optimizer = "Nelder_Mead"))
#summary(HOMElmer2) 

#Random effects of linear and qudratic age 
HOMElmer3 = lmer(HOMEETA1 ~ 1 + AGE + AGE_2 + BLACK + (1+AGE+AGE_2|SID), data = HOME, REML = FALSE,
               control=lmerControl(optimizer = "Nelder_Mead"))
summary(HOMElmer3) 
...
#Interaction with race and age 
HOMElmer4 = lmer(HOMEETA1 ~ 1 + AGE + AGE_2 + BLACK + AGE:BLACK + AGE_2:BLACK + (1+AGE+AGE_2|SID), data = HOME, REML = FALSE,
               control=lmerControl(optimizer = "Nelder_Mead")) #######DID NOT CONVERGE############

#Since model 4 did not converge, going with model 3 as best



#Get predicted values
HOME$HOMEyhat = predict(HOMElmer3, newdata = HOME, re.form = NA)
...
my_matrix <- AllData[, c("HOMEETA1", "hf_mxdpcor_12yr_TC","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOMEETA1, my_matrix$hf_mxdpcor_12yr_TC, my_matrix[,c("AGE","BLACK")])
#More stim sig associated with greater accuracy

my_matrix <- AllData[, c("HOMEETA1", "hf_mxdmnlat_12yr_TC","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOMEETA1, my_matrix$hf_mxdmnlat_12yr_TC, my_matrix[,c("AGE","BLACK")])
#Not associated with latency

#Partial correlation between HOMEETA and SDQ given "BLACK" and "AGE"
my_matrix <- AllData[, c("HOMEETA1", "StrDif_Tot","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOMEETA1, my_matrix$StrDif_Tot, my_matrix[,c("AGE","BLACK")])
#More stim sig less beh probs

#Partial correlation between HOMEETA and INR  given "BLACK" and "AGE"
my_matrix <- AllData[, c("HOMEETA1", "INR","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOMEETA1, my_matrix$INR, my_matrix[,c("AGE","BLACK")])
...
my_matrix <- AllData[, c("HOME_Mn", "hf_mxdpcor_12yr_TC","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOME_Mn, my_matrix$hf_mxdpcor_12yr_TC, my_matrix[,c("AGE","BLACK")])
#More stim sig associated with greater accuracy

my_matrix <- AllData[, c("HOME_Mn", "hf_mxdmnlat_12yr_TC","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOME_Mn, my_matrix$hf_mxdmnlat_12yr_TC, my_matrix[,c("AGE","BLACK")])
#Not associated with latency

#Partial correlation between HOME_Mn and SDQ given "BLACK" and "AGE"
my_matrix <- AllData[, c("HOME_Mn", "StrDif_Tot","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOME_Mn, my_matrix$StrDif_Tot, my_matrix[,c("AGE","BLACK")])
#More stim sig less beh probs

#Partial correlation between HOME_Mn and INR  given "BLACK" and "AGE"
my_matrix <- AllData[, c("HOME_Mn", "INR","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$HOME_Mn, my_matrix$INR, my_matrix[,c("AGE","BLACK")])
#More stim sig more INR
...
my_matrix <- AllData[, c("ESETA1","HOMEETA1","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$ESETA1, my_matrix$HOMEETA1, my_matrix[,c("AGE","BLACK")])
...
##Means
#mat dep and sociocog
my_matrix <- AllData[, c("ES_Mn","HOME_Mn","AGE", "BLACK")]
my_matrix <-na.omit(my_matrix)
pcor.test(my_matrix$ES_Mn, my_matrix$HOME_Mn, my_matrix[,c("AGE","BLACK")])
